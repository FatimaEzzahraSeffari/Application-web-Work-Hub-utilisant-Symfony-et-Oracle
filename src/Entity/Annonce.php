...
class Annonce
{
    ...
    #[ORM\ManyToMany(targetEntity: remarque::class, inversedBy: 'annonces')]
    private Collection $remarque;

    public function __construct()
    {
        $this->Apply = new ArrayCollection();
        $this->remarque = new ArrayCollection();
    }
     ...
     */
    public function getRemarque(): Collection
    {
    ...
    {
        if (!$this->remarque->contains($remarque)) {
